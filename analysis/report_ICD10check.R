...
data_processed <- data_extract %>%
  mutate(
    ...
    censor_date = pmin(dereg_date, anycovidvax_3_date+maxfup),
    ...
    admitted_primary_U071_tte = tte(anycovidvax_3_date, admitted_primary_U071_date, censor_date),
    admitted_primary_U072_tte = tte(anycovidvax_3_date, admitted_primary_U072_date, censor_date),
    admitted_primary_U099_tte = tte(anycovidvax_3_date, admitted_primary_U099_date, censor_date),
    admitted_primary_U109_tte = tte(anycovidvax_3_date, admitted_primary_U109_date, censor_date),
    admitted_primary_U07_tte = tte(anycovidvax_3_date, admitted_primary_U07_date, censor_date),
    admitted_primary_all_tte = tte(anycovidvax_3_date, admitted_primary_all_date, censor_date),

    admitted_any_U071_tte = tte(anycovidvax_3_date, admitted_any_U071_date, censor_date),
    admitted_any_U072_tte = tte(anycovidvax_3_date, admitted_any_U072_date, censor_date),
    admitted_any_U099_tte = tte(anycovidvax_3_date, admitted_any_U099_date, censor_date),
    admitted_any_U109_tte = tte(anycovidvax_3_date, admitted_any_U109_date, censor_date),
    admitted_any_U07_tte = tte(anycovidvax_3_date, admitted_any_U07_date, censor_date),
    admitted_any_all_tte = tte(anycovidvax_3_date, admitted_any_all_date, censor_date),

    death_primary_U071_tte = tte(anycovidvax_3_date, death_primary_U071_date, censor_date),
    death_primary_U072_tte = tte(anycovidvax_3_date, death_primary_U072_date, censor_date),
    death_primary_U099_tte = tte(anycovidvax_3_date, death_primary_U099_date, censor_date),
    death_primary_U109_tte = tte(anycovidvax_3_date, death_primary_U109_date, censor_date),
    death_primary_U07_tte = tte(anycovidvax_3_date, death_primary_U07_date, censor_date),
    death_primary_all_tte = tte(anycovidvax_3_date, death_primary_all_date, censor_date),

    death_any_U071_tte = tte(anycovidvax_3_date, death_any_U071_date, censor_date),
    death_any_U072_tte = tte(anycovidvax_3_date, death_any_U072_date, censor_date),
    death_any_U099_tte = tte(anycovidvax_3_date, death_any_U099_date, censor_date),
    death_any_U109_tte = tte(anycovidvax_3_date, death_any_U109_date, censor_date),
    death_any_U07_tte = tte(anycovidvax_3_date, death_any_U07_date, censor_date),
    death_any_all_tte = tte(anycovidvax_3_date, death_any_all_date, censor_date),
