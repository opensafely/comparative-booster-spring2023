...
TBD: Colm D Andrews^1^, Edward PK Parker^2^, Em Prestige^2^, Venexia Walker^3,4^, Tom Palmer^3,4^, Helen J Curtis^1^, Alex Walker^1^, Amir Mehrkar^1^, Brian MacKenna^1^, Sebastian CJ Bacon^1^, Ben Goldacre^1^, Miguel A Hernán^5,6^\*, Jonathan AC Sterne^3,7,8^\*, William J Hulme^1^, and the OpenSAFELY collaborative.
...
We considered three effectiveness outcomes. COVID-19 hospital admission was identified using Secondary Use Service (SUS) in-patient hospital spell records with International Statistical Classification of Diseases and Related Health Problems 10th Revision (ICD-10) codes U07.1, U07.2, or U.109 as the primary or non-primary reason for admission. COVID-19 critical care admissions were any COVID-19 hospital spell with at least one day spent in ciritcal care (including any such spells occurring subsequent to the first spell after vaccination). COVID-19 death was defined as COVID-19 ICD-10 codes (as before) mentioned anywhere on the death certificate (i.e., as an underlying or contributing cause of death). We also report on non-COVID-19 deaths.
...
The MHRA authorisation for Sanofi was based on clinical data from about 800 individuals previously immunised with an mRNA or viral-vectored vaccine [@Healthcare_products_Regulatory_Agency2022-us] and authorisation for Pfizer  BA.4-5 was based on the C4591001a trial, a placebo-controlled efficacy trial, finding efficacy of 86 to 100% against laboratory-confirmed COVID-19. [@Thomas2021-zm]
Real world evidence of the effectiveness of Sanofi and Pfizer BA.4-5 against hospitalisation amongst adults aged 75 years and older in England from a test-negative case control study involving 14,174 eligible tests found similar effectiveness of both Pfizer  BA.4-5 and Sanofi of 30-50%.[@Kirsebom2023-fq] 
We are aware of no other planned or published randomised trials making direct efficacy endpoint comparisons of boosting with Pfizer BA.4-5 and Sanofi. The results of our study are relevant to vaccine procurement decisions for future booster programmes. However, both vaccines are safe and strongly effective against COVID-19 hospitalisation. Findings from this study should not discourage people from receiving Sanofi booster vaccination if offered.   
...
Conceptualization: WJH, EPKP, VW, TP, BG, MAH, and JACS. Data curation: WJH, HJC, AW, AM, BM, CDA, and SCJB. Formal analysis: WJH, EPKP, and VW. Funding acquisition: JM, BG, and JACS. Methodology: WJH, EPKP, VW, TP, MAH, and JACS. Project administration: WJH, AM, JM, BG, CDA, and JACS. Resources: WJH, HJC, AW, AM, JM, BM, SCJB, and BG. Software: WJH, EPKP, and SCJB. Supervision: MAH and JACS. Validation: WJH, EPKP, CDA, and VW. Visualization: WJH, and EPKP. Writing - original draft: WJH. Writing - review & editing: WJH, EPKP, VW, TP, HJC, AW, CDA, AM, JM, BM, SCJB, BG, MAH, and JACS.
...
This study was approved by the Health Research Authority (REC reference 20/LO/0651) and by London School of Hygeine and Tropical Medicine Ethics Board (reference 21863).
...
#### Figure 1: Flow of participants into the CV cohort

![figure1](figures_manual/flowchart_cv.png){width=60%}


#### Figure 2: Flow of participants into the 75+ cohort

![figure1](figures_manual/flowchart_age75plus.png){width=40%}
