...
label_number_risk <- label_number(0.1, 10000, style_negative="minus", big.mark=",")
...
contrasts_overall %>%
  transmute(
    ...
    riskCI_0 = glue("{label_number_risk(1-surv_0)} ({label_number_risk(1-surv.ul_0)} - {label_number_risk(1-surv.ll_0)})"),
    riskCI_1 = glue("{label_number_risk(1-surv_1)} ({label_number_risk(1-surv.ul_1)} - {label_number_risk(1-surv.ll_1)})"),
    kmrdCI = glue("{label_number_risk(kmrd)} ({label_number_risk(kmrd.ll)} - {label_number_risk(kmrd.ul)})"),
    kmrrCI = glue("{label_number_rr(kmrr)} ({label_number_rr(kmrr.ll)} - {label_number_rr(kmrr.ul)})"),
