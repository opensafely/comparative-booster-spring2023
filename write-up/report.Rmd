...
plot_km <- km_estimates %>%
  ...
  geom_step(aes(x=period_end, y=1-surv))+
...
plot_kmrd
  ...
  plot_combined <- patchwork::wrap_plots(plot_km, plot_kmrd, plotkmrr, ncol=1)
  ggsave(
    filename="km.png",
    path=output_dir_rmd,
    plot=plot_combined,
