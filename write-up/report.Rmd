...
contrasts_daily <- read_csv(here("output", "release-objects", matchset, "contrasts_daily.csv")) %>% 
  mutate(
    outcome_descr = fct_recoderelevel(as.character(outcome),  recoder$outcome),
    subgroup_descr = fct_recoderelevel(subgroup,  recoder$subgroup),
    subgroup_level_descr = replace_na(subgroup_level_descr, "")
  )
contrasts_overall <- read_csv(here("output", "release-objects", matchset, "contrasts_overall.csv")) %>% 
  mutate(
    outcome_descr = fct_recoderelevel(as.character(outcome),  recoder$outcome),
    subgroup_descr = fct_recoderelevel(subgroup,  recoder$subgroup),
    subgroup_level_descr = replace_na(subgroup_level_descr, "")
...
contrasts_overall %>%
  transmute(
    ...
    n.event_0, 
    n.event_1,
    riskCI_0 = paste0(label_number(0.01)(1-surv_0), " (", label_number(0.01)(1-surv.ul_0), "-", label_number(0.01)(1-surv.ll_0), ")"),
    riskCI_1 = paste0(label_number(0.01)(1-surv_1), " (", label_number(0.01)(1-surv.ul_1), "-", label_number(0.01)(1-surv.ll_1), ")"),
  ...
  cols_label(
    ...
    riskCI_0 = "10-week Risk (95% CI)",
    riskCI_1 = "10-week Risk (95% CI)",
