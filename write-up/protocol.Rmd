...
* COVID-19 A&E attendances were identified using HES emergency care records with U07.1 ("COVID-19, virus identified") or U07.2 ("COVID-19, virus not identified") ICD-10 diagnosis codes @emergenc. This outcome also includes COVID-19 admissions (see below) to pick up more severe disease episodes that may have bypassed A&E. 
...
Alternatively, we could boostrap.
